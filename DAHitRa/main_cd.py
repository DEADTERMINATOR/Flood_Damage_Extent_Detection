...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='HarveyDataset', type=str)
    parser.add_argument('--data_name', default='Harvey', type=str)
    ...
    parser.add_argument('--net_G', default='base_transformer_pos_s4_dd8_t8_e2d4_harvey', type=str,
